...
- Timestamp: `2026-07-25T03:04:24.825840+07:00`
...
- **PASS** — endpoint registry: HTTP 200, 29.3 ms, status=ok
...
- **PASS** — exact-model smoke: wrapper_url=http://127.0.0.1:9102/v1, model=poolside/laguna-s-2.1:free, surface=chat_completions, api_key_env=WRAPPER_API_KEY, HTTP 200, 909.1 ms, returned_model=poolside/laguna-s-2.1:free, error_type=unknown,error_code=none
