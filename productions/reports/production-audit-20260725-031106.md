...
- Timestamp: `2026-07-25T03:10:58.538648+07:00`
...
- **PASS** — exact-model smoke: wrapper_url=http://127.0.0.1:9101/v1, model=nvidia/llama-3.3-nemotron-super-49b-v1, surface=chat_completions, api_key_env=WRAPPER_API_KEY, HTTP 200, 4522.9 ms, returned_model=nvidia/llama-3.3-nemotron-super-49b-v1, error_type=unknown,error_code=none
- **PASS** — exact-model smoke: wrapper_url=http://127.0.0.1:9102/v1, model=poolside/laguna-s-2.1:free, surface=chat_completions, api_key_env=WRAPPER_API_KEY, HTTP 200, 1768.2 ms, returned_model=poolside/laguna-s-2.1:free, error_type=unknown,error_code=none
- **FAIL** — exact-model smoke: wrapper_url=http://127.0.0.1:9103/v1, model=deepseek-v4-flash-free, surface=chat_completions, api_key_env=WRAPPER_API_KEY, HTTP 503, 1.6 ms, returned_model=not-present, error_type=server_error,error_code=none
- **PASS** — exact-model smoke: wrapper_url=http://127.0.0.1:9104/v1, model=blackboxai/nvidia/nemotron-nano-12b-v2-vl, surface=chat_completions, api_key_env=WRAPPER_API_KEY, HTTP 200, 1341.8 ms, returned_model=blackboxai/nvidia/nemotron-nano-12b-v2-vl, error_type=unknown,error_code=none
