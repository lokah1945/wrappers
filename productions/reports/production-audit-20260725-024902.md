...
- Timestamp: `2026-07-25T02:48:53.340286+07:00`
...
- **PASS** — endpoint registry: HTTP 200, 13.1 ms, status=ok
...
- **PASS** — endpoint blackbox: HTTP 200, 2.3 ms, status=ok
...
- **PASS** — exact-model smoke: wrapper_url=http://127.0.0.1:9101/v1, model=nvidia/llama-3.3-nemotron-super-49b-v1, surface=chat_completions, api_key_env=WRAPPER_API_KEY, HTTP 200, 534.5 ms, returned_model=nvidia/llama-3.3-nemotron-super-49b-v1, error_type=unknown,error_code=none
