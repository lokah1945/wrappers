...
- Timestamp: `2026-07-25T02:50:03.674739+07:00`
...
- **PASS** — endpoint registry: HTTP 200, 178.1 ms, status=ok
- **PASS** — endpoint nvidia: HTTP 200, 24.4 ms, status=ok
- **PASS** — endpoint nous: HTTP 200, 3.7 ms, status=ok
- **PASS** — endpoint opencode: HTTP 200, 4.5 ms, status=ok
...
- **PASS** — exact-model smoke: wrapper_url=http://127.0.0.1:9101/v1, model=nvidia/llama-3.3-nemotron-super-49b-v1, surface=chat_completions, api_key_env=WRAPPER_API_KEY, HTTP 200, 538.3 ms, returned_model=nvidia/llama-3.3-nemotron-super-49b-v1, error_type=unknown,error_code=none
