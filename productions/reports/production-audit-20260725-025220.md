...
- Timestamp: `2026-07-25T02:52:10.952748+07:00`
...
- **PASS** — endpoint registry: HTTP 200, 12.5 ms, status=ok
- **PASS** — endpoint nvidia: HTTP 200, 19.4 ms, status=ok
...
- **PASS** — exact-model smoke: wrapper_url=http://127.0.0.1:9101/v1, model=nvidia/llama-3.3-nemotron-super-49b-v1, surface=chat_completions, api_key_env=WRAPPER_API_KEY, HTTP 200, 405.8 ms, returned_model=nvidia/llama-3.3-nemotron-super-49b-v1, error_type=unknown,error_code=none
