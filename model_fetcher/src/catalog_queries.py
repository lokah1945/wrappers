    ...
    try:
        for m in models:
            ...
            """, (
                ...
                # Handle architecture - could be dict or JSON string
                (lambda arch: json.dumps(arch.get("input_modalities")) if isinstance(arch, dict) and arch.get("input_modalities") else None)(json.loads(m.get("architecture", "{}")) if isinstance(m.get("architecture"), str) else m.get("architecture", {})),
                (lambda arch: json.dumps(arch.get("output_modalities")) if isinstance(arch, dict) and arch.get("output_modalities") else None)(json.loads(m.get("architecture", "{}")) if isinstance(m.get("architecture"), str) else m.get("architecture", {})),
                (lambda arch: arch.get("tokenizer") if isinstance(arch, dict) else None)(json.loads(m.get("architecture", "{}")) if isinstance(m.get("architecture"), str) else m.get("architecture", {})),
                (lambda arch: arch.get("instruct_type") if isinstance(arch, dict) else None)(json.loads(m.get("architecture", "{}")) if isinstance(m.get("architecture"), str) else m.get("architecture", {})),
                # Handle pricing - could be dict or JSON string
                (lambda p: p.get("prompt") if isinstance(p, dict) else None)(json.loads(m.get("pricing", "{}")) if isinstance(m.get("pricing"), str) else m.get("pricing", {})),
                (lambda p: p.get("completion") if isinstance(p, dict) else None)(json.loads(m.get("pricing", "{}")) if isinstance(m.get("pricing"), str) else m.get("pricing", {})),
                # Handle top_provider - could be dict or JSON string
                (lambda tp: tp.get("context_length") if isinstance(tp, dict) else None)(json.loads(m.get("top_provider", "{}")) if isinstance(m.get("top_provider"), str) else m.get("top_provider", {})),
                (lambda tp: tp.get("max_completion_tokens") if isinstance(tp, dict) else None)(json.loads(m.get("top_provider", "{}")) if isinstance(m.get("top_provider"), str) else m.get("top_provider", {})),
                (lambda tp: tp.get("is_moderated") if isinstance(tp, dict) else None)(json.loads(m.get("top_provider", "{}")) if isinstance(m.get("top_provider"), str) else m.get("top_provider", {})),
