#!/usr/bin/env python3
"""Persistent metrics for wrapper-vercel.
...
class Metrics:
    ...
    def prom_metrics(self) -> str:
        with self._lock:
            return f"""# HELP vercel_requests_total Total requests
# TYPE vercel_requests_total counter
vercel_requests_total {self.requests}
# HELP vercel_tokens_total Total tokens
# TYPE vercel_tokens_total counter
vercel_tokens_total {self.tokens_in + self.tokens_out}
# HELP vercel_errors_total Total errors
# TYPE vercel_errors_total counter
vercel_errors_total {self.errors}
"""
