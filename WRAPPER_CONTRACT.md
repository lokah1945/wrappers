...
**Version:** 3.3 (2026-08-04)
**Supersedes:** 3.2 (2026-08-04)
...
A wrapper is **not** contract-compliant until it passes all nine gates.
...
# 9. Hostile-body FUZZ E2E — 32 malformed/adversarial request bodies per
#    wrapper × surface (JSON of every type, truncated/BOM/NaN bodies,
#    wrong-typed fields, negative/huge max_tokens, deep nesting, oversized
...
- **Verification:** 315 unit · 990 runtime E2E · 240 full-matrix · 55 agent-loop · multi-agent storm · official-SDK compat · COMPATIBILITY_LAYER E2E · soak · **1081 fuzz checks** — **9/9 gates green, 0 failures**.
